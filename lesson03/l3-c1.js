...
l3c1.push("Remember, indexing is zero based.");
    console.log(l3c1[l3c1.length-1]); // why does this return a 6?
    console.log(l3c1[5] + " (previous element added to array)"); // here text
    console.log((l3c1[2]) + ' ' + (l3c1[l3c1.length-1])); // text and a 6
...
// console.log(l3c1); // including this line drops prev text output
